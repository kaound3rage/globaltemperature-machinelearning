...
# Simpan model lengkap (pkl) untuk keperluan re-training
...
# Simpan RESULTS saja sebagai JSON — dipakai Lambda (tanpa pickle/class dependency)
results_payload = {
    "version"      : "1.0.0",
    "trained_at"   : forecaster.trained_at,
    "forecast_years": FORECAST_YEARS,
...
s3.put_object(
    Bucket      = S3_BUCKET,
    Key         = "models/forecast_results.json",
    Body        = json.dumps(results_payload, indent=2),
    ContentType = "application/json"
)
print(f"  ✓ Forecast results disimpan ke s3://{S3_BUCKET}/models/forecast_results.json")
